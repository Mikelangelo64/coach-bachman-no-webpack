...
vevet.pageLoad.onLoaded(function () {
    ...
    var rotateItem = function (itemProps, section) {
        ...
        var render = function () {
            progress.current = Vevet.utils.math.lerp(progress.current, progress.target, 0.1);
            item.style.transform = "rotate(".concat((progress.current - 0.5) * 10, "deg)");
            ...
            useObserver({
                ...
                callbackIn: function () {
                    marqueeArray.forEach(function (item) {
                        ...
                        var _a = rotateItem(item, section), listener = _a.listener, frame = _a.frame;
    ...
    var makeSlider = function (_a) {
        var container = _a.container, className = _a.className, _b = _a.isThumb, isThumb = _b === void 0 ? false : _b, _c = _a.thumb, thumb = _c === void 0 ? undefined : _c, config = _a.config;
    ...
    var moveHoverImageInit = function (_a) {
        var containerClass = _a.containerClass, labelClass = _a.labelClass, _b = _a.isReverse, isReverse = _b === void 0 ? false : _b;
        ...
        containerArray.forEach(function (container) {
            ...
            frame.addCallback('frame', function () {
                progressX.current = Vevet.utils.math.lerp(progressX.current, progressX.target, 0.1);
                progressY.current = Vevet.utils.math.lerp(progressY.current, progressY.target, 0.1);
                label.style.transform = "translate(".concat(progressX.current * 30, "px, ").concat(progressY.current * 30, "px)");
                if (progressX.current === progressX.target &&
            ...
            container.addEventListener('mousemove', function (evt) {
                ...
                var y = Math.min(Math.max(evt.clientY - startY, 0), rect.height) /
                    rect.height;
                var x = Math.min(Math.max(evt.clientX - startX, 0), rect.width) / rect.width;
    ...
    var useScrollEvent = function (_a) {
        var target = _a.target, callback = _a.callback, _b = _a.isImmediate, isImmediate = _b === void 0 ? true : _b;
        if (!target) {
            return {
                hidden: undefined,
                shown: undefined
        ...
        container.style.minHeight = "".concat(hidden.height * 1.5 + shown.height, "px");
        var listener = function () {
            var rect = container.getBoundingClientRect();
        ...
        window.addEventListener('resize', debounce({
            callback: function () {
                var newHiddenHeight = Math.ceil(hidden.dom.getBoundingClientRect().height);
                var newShownHeight = Math.ceil(shown.dom.getBoundingClientRect().height);
                if (hidden.height === newHiddenHeight &&
                    newShownHeight === shown.height) {
                    return;
                }
                hidden.height = newHiddenHeight;
                shown.height = newShownHeight;
                container.style.minHeight = "".concat(hidden.height * 2 + shown.height, "px");
                clearScrollListener(listener);
                window.addEventListener('scroll', listener);
            }
        }));
    ...
    var opacityRender = function (_a) {
        var progress = _a.progress, itemDom = _a.itemDom;
        var item = itemDom;
    ...
    var clipPathRender = function (_a) {
        var progress = _a.progress, itemDom = _a.itemDom;
        var item = itemDom;
        item.style.clipPath = "inset(0% ".concat(progress * 100, "% ").concat(progress * 100, "% 0 round 0 0 ").concat(vevet.isPhone ? 16 : 30 + progress * 20, "% 0)");
    };
    var splitRender = function (_a) {
        var progress = _a.progress, itemDom = _a.itemDom, additionalItemDom = _a.additionalItemDom;
    ...
    var makeAppearAnimation = function (_a) {
        var container = _a.container, renderFunc = _a.renderFunc, _b = _a.animateElement, animateElement = _b === void 0 ? null : _b;
        var frame = new Vevet.AnimationFrame({ fps: 60 });
        frame.play();
        ...
        var _c = useScrollEvent({
            ...
            callback: function (_a) {
                ...
                if ((progressAnimation.target < 1 || progressAnimation.target > 0) &&
                    !frame.isPlaying) {
                    frame.play();
                }
            }
        }), hidden = _c.hidden, shown = _c.shown;
        if (!hidden || !shown) {
            return;
        }
        var render = function () {
            ...
            progressAnimation.current = Vevet.utils.math.lerp(progressAnimation.current, progressAnimation.target, 0.4);
    ...
    var appearInit = function () {
        ...
        containerArray.forEach(function (container) {
            var isIncludeMobile = container.dataset.includeMobile === 'include' || false;
            ...
            if (animateElement) {
                animationType =
                    animateElement.dataset.animate ||
                        'opacity';
            }
            ...
            makeAppearAnimation({ container: container, renderFunc: renderFunc, animateElement: animateElement });
        });
    };
    appearInit();
